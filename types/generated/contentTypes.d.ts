...
export interface ApiActivationCardActivationCard
  extends Struct.CollectionTypeSchema {
  collectionName: 'activation_cards';
  info: {
    displayName: 'activation-card';
    pluralName: 'activation-cards';
    singularName: 'activation-card';
  };
  options: {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::activation-card.activation-card': ApiActivationCardActivationCard;
